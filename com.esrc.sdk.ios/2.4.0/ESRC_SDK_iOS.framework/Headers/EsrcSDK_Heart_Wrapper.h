...
+ (void) EsrcSDK_Heart_FeedEngagementRecognitionTimeDomainTask: (double) hr param2: (double *) probs param3: (int *) engagement;
+ (void) EsrcSDK_Heart_FeedEngagementRecognitionFrequencyDomainTask: (double *) hrv param2: (double *) probs param3: (int *) engagement;
